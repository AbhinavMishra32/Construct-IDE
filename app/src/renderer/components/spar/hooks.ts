...
/**
 * Mirror of a primitive's own open/value state, so an animated wrapper can hold
 * a surface in the tree for the length of its exit. Radix drops a closed
 * overlay immediately, which leaves nothing for AnimatePresence to animate out.
 */
