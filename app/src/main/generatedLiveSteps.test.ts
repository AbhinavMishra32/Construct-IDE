...
describe("generated live step validation", () => {
  ...
  it("rejects invalid insertion targets and unsupported code-edit blocks", () => {
    const drafts = [
      {
        source: "construct-interact",
      ...
      },
      {
        ...
        insertAfterStepId: "step-2",
        title: "Edit code",
        reason: "Generated live steps cannot edit files yet.",
    ...
    assert.match(result.validation[1].reason, /Unsupported live step block kind/);
  });
