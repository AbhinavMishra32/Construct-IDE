...
/** How deep each fade runs once it is on. Mirrors `--drum-fade` in spar-shell.css. */
const FADE = "2.25rem";
 ...
 * drum. See `.drum` in spar-shell.css for how the effect is built.
 *
 ...
 */
export function SparScrollDrum({
  children,
  className,
  maxHeight,
}: {
