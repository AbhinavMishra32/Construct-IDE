...
/**
 * Which copy of Construct this is. A packaged release is identified by its version,
...
export function buildInfo(): BuildInfo {
  ...
  const baked = process.env.CONSTRUCT_COMMIT?.trim();
  ...
  cached = {
    ...
    branch: process.env.CONSTRUCT_BRANCH?.trim() || head.branch,
