...
export type Page = "today" | "baseline" | "tracks" | "track" | "progress" | "history" | "problems" | "sessions" | "ability" | "challenges" | "challenge" | "settings" | "workspace";
        ...
        {NAV.map(({ id, label, icon: Icon }) => (
          <button
            ...
            className={cn(
              ...
              page === id || (id === "tracks" && page === "track") || (id === "today" && page === "baseline") || (id === "history" && page === "challenge")
